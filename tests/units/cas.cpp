...
TEST(CAS1b, Negative)
{
    ...
    EXPECT_FALSE(xtomic::atomic_cas(a, static_cast<value_type>(0), static_cast<value_type>(1)));
...
TEST(CAS1b, Positive)
{
    ...
    EXPECT_TRUE(xtomic::atomic_cas(a, static_cast<value_type>(1), static_cast<value_type>(2)));
...
TEST(CAS8b, Negative)
{
    ...
    EXPECT_FALSE(xtomic::atomic_cas(a, value_type(0), value_type(1)));
    EXPECT_EQ(a, 1);
}
...
TEST(CAS8b, Positive)
{
    ...
    EXPECT_TRUE(xtomic::atomic_cas(a, value_type(1, 2), value_type(3, 4)));
    ...
    EXPECT_TRUE(xtomic::atomic_cas(var, e, n));
    EXPECT_EQ(var, n);
...
TEST(CAS16b, Negative)
{
    ...
    EXPECT_FALSE(xtomic::atomic_cas(a, value_type(0, 1), value_type(1, 1)));
